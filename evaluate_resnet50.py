...
model = load_model("outputs/models/resnet50_best.keras")
...
with open(
    "outputs/reports/resnet50_classification_report.txt",
    "w",
) as f:
    f.write(report)
...
plt.savefig(
    "outputs/confusion_matrix/resnet50_confusion_matrix.png"
)
...
plt.savefig(
    "outputs/roc/resnet50_roc_curve.png"
)
...
print("ResNet50 Confusion Matrix Saved")
print("ResNet50 ROC Curve Saved")
print("ResNet50 Classification Report Saved")