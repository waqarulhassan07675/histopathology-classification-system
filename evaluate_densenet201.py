...
model = load_model("outputs/models/densenet201_best.keras")
...
with open(
    "outputs/reports/densenet201_classification_report.txt",
    "w",
) as f:
    f.write(report)
...
plt.savefig(
    "outputs/confusion_matrix/densenet201_confusion_matrix.png",
    dpi=300,
)
...
plt.savefig(
    "outputs/roc/densenet201_roc_curve.png",
    dpi=300,
)
...
print("DenseNet201 Confusion Matrix Saved")
print("DenseNet201 ROC Curve Saved")
print("DenseNet201 Classification Report Saved")